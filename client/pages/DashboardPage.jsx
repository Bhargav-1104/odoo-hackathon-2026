  ...
  return (
    <div className="dash-root">
      <DashboardShell
        ...
        sidebar={<DashboardSidebar onNavigate={() => setSidebarOpen(false)} />}
      >
        <DashboardHeader
        ...
        <div className="dash-content">
          ...
          <section className="dash-stats" aria-label="Travel statistics">
            ...
            <StatCard
              ...
              hint={stats.nextTripDays === null ? "Add dates to see a countdown" : "Until your nearest start date"}
            />
          </section>

          <div className="dash-panels">
            <section className="dash-panel" id="dash-upcoming" aria-labelledby="dash-upcoming-title">
              <div className="dash-panel__head">
                ...
                <button type="button" className="dash-btn-ghost" onClick={() => setModalOpen(true)}>
                  Add trip
                </button>
              </div>
            ...
            <section className="dash-panel" aria-labelledby="dash-activity-title">
              <div className="dash-panel__head">
                <div>
                  ...
                  <p className="dash-panel__caption">A lightweight timeline of changes in your workspace.</p>
                </div>
              </div>
